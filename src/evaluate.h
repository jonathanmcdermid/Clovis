...
#define S(mg, eg) Score(mg, eg)
        ...
        constexpr Score pawn_table[] = {
			...
			S(102, 280), S(145, 259), S(153, 231), S(161, 219),
			S(77, 90), S(96, 88), S(117, 83), S(116, 82),
			S(61, 80), S(80, 76), S(83, 76), S(97, 68),
			S(53, 72), S(62, 73), S(77, 70), S(93, 68),
			S(59, 67), S(72, 67), S(76, 71), S(79, 76),
			S(55, 68), S(77, 67), S(71, 80), S(71, 81),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};

		constexpr Score knight_table[] = {
			S(179, 188), S(246, 205), S(223, 232), S(304, 218),
			S(273, 213), S(298, 230), S(377, 212), S(326, 238),
			S(310, 212), S(352, 223), S(342, 244), S(354, 240),
			S(328, 224), S(329, 241), S(337, 252), S(337, 258),
			S(320, 223), S(334, 238), S(339, 249), S(338, 253),
			S(314, 221), S(336, 229), S(338, 235), S(342, 248),
			S(315, 206), S(310, 223), S(328, 230), S(337, 233),
			S(289, 203), S(319, 196), S(305, 222), S(320, 223),
		};

		constexpr Score bishop_table[] = {
			S(315, 228), S(331, 232), S(332, 229), S(330, 235),
			S(317, 231), S(348, 221), S(346, 234), S(345, 236),
			S(324, 238), S(345, 238), S(355, 239), S(344, 245),
			S(324, 239), S(330, 239), S(333, 245), S(349, 243),
		};

		constexpr Score rook_table[] = {
			S(442, 431), S(435, 439), S(445, 436), S(445, 435),
			S(416, 443), S(435, 438), S(442, 437), S(451, 432),
			S(421, 441), S(441, 440), S(442, 436), S(438, 437),
			S(419, 445), S(435, 440), S(442, 443), S(443, 437),
		};

		constexpr Score queen_table[] = {
			S(887, 799), S(874, 820), S(874, 835), S(895, 816),
			S(885, 798), S(839, 836), S(860, 839), S(829, 868),
			S(897, 797), S(884, 816), S(885, 821), S(858, 855),
			S(879, 824), S(872, 837), S(871, 829), S(865, 844),
			S(896, 795), S(882, 832), S(886, 822), S(886, 832),
			S(889, 809), S(908, 793), S(897, 814), S(897, 809),
			S(888, 792), S(903, 778), S(915, 778), S(909, 794),
			S(905, 771), S(896, 775), S(896, 778), S(910, 767),
		};

		constexpr Score king_table[] = {
			S(72, 18), S(106, 37), S(68, 61), S(72, 58),
			S(81, 42), S(108, 54), S(74, 76), S(51, 86),
			S(56, 55), S(93, 69), S(76, 83), S(65, 92),
			S(24, 59), S(69, 78), S(54, 93), S(37, 102),
		};

		constexpr Score passed_pawn[] = {
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(8, 3), S(5, 4), S(6, 3), S(7, 3),
			S(10, 121), S(0, 112), S(12, 87), S(2, 67),
			S(13, 61), S(5, 57), S(10, 38), S(6, 32),
			S(10, 34), S(0, 32), S(0, 18), S(0, 15),
			S(5, 11), S(0, 13), S(0, 3), S(0, 0),
			S(0, 11), S(0, 9), S(2, 0), S(0, 0),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};
