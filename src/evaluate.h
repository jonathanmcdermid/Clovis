...
#define S(mg, eg) Score(mg, eg)
			...
			S(109, 279), S(149, 257), S(159, 230), S(166, 218),
			S(74, 86), S(94, 80), S(111, 78), S(107, 62),
			S(60, 77), S(79, 71), S(81, 71), S(94, 64),
			S(52, 70), S(62, 70), S(75, 67), S(91, 64),
			S(58, 64), S(71, 65), S(75, 69), S(78, 73),
			S(54, 66), S(76, 64), S(70, 77), S(70, 77),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};

		constexpr Score knight_table[] = {
			S(177, 184), S(245, 200), S(221, 227), S(299, 213),
			S(270, 209), S(293, 226), S(371, 208), S(322, 233),
			S(305, 208), S(350, 217), S(339, 239), S(349, 236),
			S(326, 219), S(327, 235), S(335, 246), S(335, 252),
			S(318, 219), S(332, 233), S(337, 244), S(336, 247),
			S(313, 216), S(334, 224), S(336, 230), S(341, 242),
			S(313, 202), S(309, 218), S(326, 226), S(335, 228),
			S(288, 198), S(317, 191), S(304, 217), S(319, 218),
		};

		constexpr Score bishop_table[] = {
			S(313, 223), S(328, 227), S(330, 224), S(328, 230),
			S(314, 226), S(346, 215), S(343, 229), S(342, 230),
			S(322, 233), S(342, 232), S(352, 233), S(342, 239),
			S(321, 234), S(328, 233), S(331, 239), S(347, 237),
		};

		constexpr Score rook_table[] = {
			S(441, 421), S(434, 428), S(444, 425), S(445, 424),
			S(416, 432), S(433, 428), S(440, 426), S(450, 421),
			S(419, 430), S(439, 430), S(440, 426), S(437, 426),
			S(418, 434), S(434, 430), S(441, 432), S(442, 427),
		};

		constexpr Score queen_table[] = {
			S(885, 782), S(866, 807), S(865, 821), S(890, 801),
			S(883, 781), S(840, 816), S(857, 823), S(829, 850),
			S(893, 782), S(881, 800), S(881, 806), S(856, 839),
			S(876, 809), S(870, 819), S(869, 813), S(862, 826),
			S(895, 778), S(880, 814), S(885, 804), S(884, 815),
			S(888, 793), S(907, 775), S(895, 797), S(896, 792),
			S(888, 774), S(903, 761), S(914, 762), S(908, 777),
			S(905, 754), S(895, 759), S(896, 762), S(909, 753),
		};
		...
		constexpr Score passed_pawn[] = {
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(11, 121), S(1, 116), S(17, 89), S(10, 84),
			S(14, 61), S(6, 59), S(10, 41), S(6, 33),
