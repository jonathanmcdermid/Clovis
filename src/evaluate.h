...
#define S(mg, eg) Score(mg, eg)
			...
			S(179, 248), S(191, 248), S(162, 238), S(198, 205),
			S(71, 97), S(95, 96), S(112, 87), S(107, 42),
			S(63, 86), S(79, 81), S(90, 76), S(102, 74),
			S(58, 77), S(67, 80), S(82, 75), S(100, 70),
			S(62, 71), S(73, 73), S(78, 76), S(83, 80),
			S(57, 73), S(78, 75), S(73, 83), S(70, 84),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};

		constexpr Score knight_table[] = {
			S(242, 202), S(297, 212), S(284, 238), S(306, 234),
			S(306, 215), S(299, 238), S(318, 241), S(322, 244),
			S(302, 225), S(319, 238), S(321, 246), S(329, 255),
			S(306, 239), S(312, 246), S(326, 254), S(323, 261),
		};

		constexpr Score bishop_table[] = {
			S(304, 233), S(346, 223), S(317, 238), S(320, 240),
			S(304, 239), S(336, 223), S(334, 237), S(331, 242),
			S(316, 241), S(334, 240), S(337, 242), S(334, 245),
			S(308, 244), S(313, 243), S(320, 245), S(330, 241),
		};

		constexpr Score rook_table[] = {
			S(444, 439), S(442, 442), S(444, 442), S(446, 440),
			S(421, 444), S(442, 438), S(455, 433), S(453, 433),
			S(437, 441), S(444, 442), S(448, 437), S(453, 438),
			S(430, 449), S(447, 442), S(449, 442), S(457, 439),
		};

		constexpr Score queen_table[] = {
			S(871, 825), S(850, 850), S(834, 865), S(868, 849),
			S(881, 813), S(851, 847), S(865, 857), S(827, 881),
			S(898, 817), S(896, 826), S(889, 838), S(869, 865),
			S(884, 839), S(877, 849), S(876, 848), S(872, 853),
			S(899, 817), S(893, 838), S(894, 827), S(893, 850),
			S(895, 823), S(908, 817), S(898, 837), S(899, 841),
			S(899, 797), S(915, 788), S(915, 808), S(914, 815),
			S(901, 791), S(893, 798), S(896, 795), S(908, 792),
		};

		constexpr Score king_table[] = {
			S(76, 13), S(105, 35), S(71, 58), S(68, 59),
			S(87, 44), S(108, 55), S(79, 73), S(51, 85),
			S(43, 63), S(88, 68), S(68, 85), S(60, 94),
			S(34, 63), S(70, 79), S(73, 91), S(41, 101),
		};

		constexpr Score passed_pawn[] = {
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(37, 113), S(24, 112), S(35, 89), S(33, 111),
			S(36, 59), S(24, 63), S(13, 47), S(7, 34),
			S(12, 40), S(7, 41), S(0, 23), S(0, 20),
			S(0, 12), S(0, 20), S(0, 7), S(0, 0),
			S(2, 15), S(0, 13), S(0, 2), S(0, 4),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};
		...
		constexpr Score candidate_passer[] = {
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(28, 72), S(0, 66), S(24, 71), S(45, 94),
			S(66, 52), S(13, 53), S(19, 47), S(9, 41),
			S(20, 24), S(21, 21), S(13, 18), S(0, 30),
			S(0, 13), S(0, 8), S(2, 7), S(0, 10),
			S(10, 2), S(0, 1), S(0, 7), S(2, 20),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};
		...
		constexpr Score weak_queen_penalty = S(31, 8);
		constexpr Score rook_on_our_passer_file = S(5, 7);
		constexpr Score rook_on_their_passer_file = S(3, 30);
		constexpr Score tall_pawn_penalty = S(11, 23);
		constexpr Score fianchetto_bonus = S(16, 11);
		...
		constexpr short attack_factor = 57;
