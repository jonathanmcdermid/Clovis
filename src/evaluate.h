...
#define S(mg, eg) Score(mg, eg)
			...
			S(179, 248), S(190, 248), S(163, 237), S(198, 205),
			S(72, 97), S(91, 97), S(110, 87), S(112, 49),
		...
		constexpr Score knight_table[] = {
			S(242, 202), S(297, 211), S(284, 238), S(305, 234),
			S(306, 215), S(299, 238), S(318, 241), S(322, 244),
			S(302, 225), S(319, 238), S(321, 246), S(329, 255),
			S(306, 239), S(312, 246), S(326, 253), S(323, 261),
		};

		constexpr Score bishop_table[] = {
			S(304, 232), S(346, 222), S(317, 238), S(320, 240),
			S(304, 239), S(336, 223), S(334, 236), S(331, 242),
			S(316, 240), S(334, 240), S(337, 241), S(334, 245),
			S(308, 243), S(314, 243), S(320, 244), S(331, 241),
		};
		...
		constexpr Score queen_table[] = {
			S(872, 823), S(851, 849), S(835, 864), S(870, 848),
			S(882, 813), S(852, 846), S(866, 856), S(829, 880),
			S(900, 816), S(897, 826), S(890, 837), S(871, 863),
			S(885, 839), S(878, 848), S(877, 846), S(874, 851),
			S(901, 816), S(895, 837), S(896, 826), S(894, 848),
			S(896, 821), S(910, 816), S(899, 835), S(900, 840),
			S(901, 795), S(916, 787), S(916, 806), S(915, 813),
			S(902, 791), S(895, 797), S(897, 794), S(910, 790),
		};

		constexpr Score king_table[] = {
			S(76, 13), S(105, 35), S(71, 58), S(68, 59),
			S(87, 44), S(108, 55), S(79, 73), S(50, 85),
			S(43, 63), S(88, 68), S(67, 85), S(60, 94),
		...
		constexpr Score passed_pawn[] = {
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(35, 113), S(27, 111), S(37, 88), S(28, 104),
			S(34, 59), S(23, 63), S(13, 47), S(8, 34),
			S(11, 40), S(7, 41), S(0, 23), S(0, 20),
		...
		constexpr Score candidate_passer[] = {
			S(0, 0), S(0, 6), S(0, 9), S(7, 24), S(20, 48), S(30, 65), S(0, 0), S(0, 0),
		};
