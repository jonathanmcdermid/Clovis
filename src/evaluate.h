...
#define S(mg, eg) Score(mg, eg)
        ...
        constexpr Score pawn_table[] = {
			...
			S(102, 281), S(145, 259), S(153, 232), S(161, 219),
			S(78, 90), S(97, 88), S(119, 83), S(113, 83),
			S(62, 80), S(81, 76), S(84, 76), S(95, 68),
			S(54, 72), S(64, 73), S(79, 70), S(90, 68),
			S(60, 66), S(73, 66), S(78, 71), S(76, 76),
			S(56, 68), S(78, 67), S(73, 79), S(68, 82),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};

		constexpr Score knight_table[] = {
			S(180, 187), S(245, 207), S(225, 233), S(302, 220),
			S(270, 216), S(295, 232), S(375, 214), S(322, 241),
			S(307, 214), S(349, 225), S(339, 247), S(352, 243),
			S(326, 226), S(326, 243), S(334, 255), S(333, 261),
			S(317, 226), S(332, 240), S(336, 252), S(336, 256),
			S(312, 224), S(334, 232), S(336, 238), S(340, 251),
			S(312, 208), S(306, 226), S(325, 233), S(334, 236),
			S(288, 204), S(316, 197), S(302, 224), S(318, 225),
		};

		constexpr Score bishop_table[] = {
			S(312, 230), S(329, 235), S(329, 232), S(326, 238),
			S(314, 234), S(345, 223), S(342, 237), S(341, 239),
			S(321, 241), S(342, 240), S(352, 241), S(341, 247),
			S(321, 241), S(327, 241), S(330, 247), S(345, 246),
		};

		constexpr Score rook_table[] = {
			S(437, 436), S(430, 443), S(441, 440), S(440, 440),
			S(412, 447), S(430, 443), S(437, 441), S(445, 436),
			S(416, 445), S(436, 444), S(437, 441), S(433, 441),
			S(415, 449), S(431, 445), S(437, 447), S(439, 442),
		};

		constexpr Score queen_table[] = {
			S(898, 794), S(881, 819), S(883, 833), S(902, 815),
			S(896, 794), S(848, 834), S(871, 838), S(840, 866),
			S(909, 794), S(898, 812), S(895, 819), S(869, 852),
			S(892, 821), S(885, 833), S(883, 825), S(875, 841),
			S(909, 791), S(894, 829), S(898, 818), S(899, 828),
			S(902, 805), S(921, 789), S(910, 810), S(909, 805),
			S(901, 788), S(916, 773), S(928, 774), S(921, 790),
			S(918, 767), S(909, 772), S(909, 775), S(922, 763),
		};
		...
		constexpr Score king_table[] = {
			...
			S(18, 59), S(66, 78), S(56, 94), S(43, 102),
		};

		constexpr Score passed_pawn[] = {
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(8, 4), S(5, 4), S(6, 4), S(7, 3),
			S(10, 122), S(0, 113), S(10, 88), S(3, 67),
			S(12, 62), S(4, 58), S(8, 39), S(6, 32),
			S(10, 34), S(0, 33), S(0, 18), S(0, 15),
			S(6, 11), S(0, 14), S(0, 3), S(0, 0),
