...
#define S(mg, eg) Score(mg, eg)
        ...
        constexpr Score pawn_table[] = {
			...
			S(110, 283), S(151, 261), S(159, 234), S(169, 221),
			S(77, 90), S(97, 87), S(117, 83), S(116, 82),
			S(61, 80), S(80, 76), S(83, 76), S(97, 68),
			S(53, 72), S(62, 73), S(77, 70), S(93, 67),
			S(59, 66), S(72, 67), S(76, 71), S(79, 75),
			S(55, 68), S(77, 67), S(71, 79), S(71, 81),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};

		constexpr Score knight_table[] = {
			S(180, 187), S(247, 204), S(224, 231), S(305, 216),
			S(274, 212), S(299, 228), S(378, 211), S(327, 236),
			S(311, 211), S(353, 221), S(343, 243), S(356, 239),
			S(329, 222), S(330, 239), S(338, 251), S(338, 256),
			S(321, 222), S(335, 237), S(340, 248), S(339, 252),
			S(316, 220), S(338, 228), S(339, 234), S(344, 246),
			S(316, 205), S(311, 222), S(329, 229), S(338, 232),
			S(290, 202), S(320, 194), S(306, 221), S(321, 221),
		};

		constexpr Score bishop_table[] = {
			S(317, 227), S(333, 231), S(334, 228), S(331, 234),
			S(319, 230), S(350, 219), S(347, 233), S(346, 235),
			S(325, 237), S(346, 236), S(357, 237), S(346, 243),
			S(325, 237), S(332, 237), S(335, 243), S(351, 242),
		};

		constexpr Score rook_table[] = {
			S(444, 429), S(436, 437), S(446, 434), S(447, 433),
			S(418, 440), S(436, 436), S(444, 435), S(452, 430),
			S(422, 439), S(443, 438), S(443, 434), S(440, 435),
			S(421, 443), S(437, 438), S(444, 441), S(445, 435),
		};

		constexpr Score queen_table[] = {
			S(887, 797), S(873, 819), S(873, 833), S(895, 814),
			S(885, 796), S(839, 834), S(860, 838), S(829, 867),
			S(896, 796), S(884, 815), S(885, 820), S(858, 853),
			S(879, 822), S(871, 835), S(870, 828), S(864, 842),
			S(896, 794), S(881, 831), S(886, 821), S(885, 831),
			S(889, 808), S(908, 791), S(896, 813), S(896, 808),
			S(888, 790), S(903, 777), S(915, 777), S(909, 792),
			S(905, 769), S(896, 774), S(896, 777), S(909, 766),
		};
		...
		constexpr Score king_table[] = {
			...
			S(24, 58), S(69, 77), S(54, 93), S(37, 102),
		};

		constexpr Score passed_pawn[] = {
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(10, 120), S(0, 112), S(12, 86), S(2, 67),
