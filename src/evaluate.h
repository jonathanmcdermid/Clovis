...
#define S(mg, eg) Score(mg, eg)
			...
			S(111, 278), S(149, 257), S(158, 230), S(166, 218),
			S(75, 86), S(93, 80), S(110, 78), S(107, 62),
			S(61, 77), S(79, 71), S(81, 71), S(95, 64),
			S(52, 70), S(62, 70), S(76, 67), S(91, 64),
			S(58, 64), S(71, 65), S(75, 69), S(78, 73),
			S(54, 65), S(76, 64), S(70, 77), S(71, 77),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};

		constexpr Score knight_table[] = {
			S(176, 184), S(245, 200), S(222, 227), S(297, 213),
			S(269, 209), S(293, 225), S(368, 208), S(323, 232),
			S(304, 207), S(350, 217), S(339, 238), S(350, 235),
			S(325, 218), S(326, 235), S(334, 246), S(335, 251),
			S(317, 219), S(331, 232), S(336, 243), S(336, 247),
			S(311, 216), S(333, 224), S(335, 229), S(340, 241),
			S(312, 202), S(310, 218), S(325, 225), S(335, 227),
			S(288, 198), S(316, 191), S(303, 217), S(318, 217),
		};

		constexpr Score bishop_table[] = {
			S(312, 223), S(328, 227), S(330, 224), S(327, 230),
			S(313, 226), S(345, 215), S(343, 229), S(342, 230),
			S(322, 233), S(341, 232), S(352, 233), S(341, 239),
			S(321, 233), S(328, 233), S(330, 239), S(345, 238),
		};

		constexpr Score rook_table[] = {
			S(440, 420), S(433, 428), S(443, 425), S(444, 423),
			S(415, 432), S(432, 428), S(439, 426), S(448, 421),
			S(419, 430), S(438, 429), S(440, 426), S(438, 426),
			S(417, 434), S(433, 429), S(441, 432), S(442, 426),
		};

		constexpr Score queen_table[] = {
			S(883, 781), S(863, 807), S(865, 818), S(884, 803),
			S(881, 782), S(840, 816), S(860, 819), S(832, 848),
			S(893, 782), S(882, 799), S(882, 803), S(861, 835),
			S(874, 810), S(869, 820), S(869, 811), S(862, 825),
			S(893, 778), S(879, 814), S(882, 805), S(882, 813),
			S(887, 792), S(904, 776), S(892, 798), S(894, 791),
			S(887, 774), S(900, 760), S(912, 761), S(906, 776),
			S(903, 754), S(894, 758), S(895, 761), S(907, 753),
		};

		constexpr Score king_table[] = {
			S(72, 18), S(105, 37), S(67, 61), S(72, 58),
			S(81, 42), S(109, 54), S(75, 75), S(50, 86),
			S(56, 55), S(93, 68), S(77, 82), S(64, 91),
			S(22, 59), S(68, 77), S(55, 92), S(38, 101),
		};

		constexpr Score passed_pawn[] = {
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(11, 120), S(3, 116), S(17, 89), S(10, 84),
			S(14, 61), S(6, 59), S(9, 41), S(6, 33),
			S(11, 34), S(0, 33), S(0, 18), S(0, 16),
			S(5, 12), S(0, 14), S(0, 3), S(0, 1),
			S(0, 12), S(1, 10), S(5, 0), S(0, 2),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};

		constexpr Score candidate_passer[] = {
			S(0, 0), S(0, 1), S(0, 4), S(5, 17), S(11, 36), S(22, 48), S(0, 0), S(0, 0),
		};

		constexpr Score mobility[] = {
			S(0, 0), S(0, 0), S(5, 1), S(4, 2), S(4, 2), S(2, 3), S(0, 0),
		};
		...
		constexpr Score rook_on_seventh = S(1, 24);
		...
		constexpr short weak_square = 20;
