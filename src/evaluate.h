...
#define S(mg, eg) Score(mg, eg)
		...
		constexpr Score pawn_table[] = {
			...
			S(104, 283), S(148, 260), S(156, 233), S(163, 220),
			S(78, 91), S(98, 88), S(120, 83), S(113, 83),
			S(61, 81), S(81, 76), S(85, 76), S(95, 69),
			S(53, 73), S(63, 73), S(79, 70), S(90, 69),
			S(60, 67), S(72, 67), S(77, 72), S(76, 77),
			S(55, 69), S(77, 68), S(72, 80), S(66, 84),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};

		constexpr Score knight_table[] = {
			S(183, 188), S(249, 207), S(226, 233), S(303, 221),
			S(273, 216), S(299, 232), S(381, 214), S(325, 241),
			S(310, 215), S(353, 226), S(342, 248), S(354, 244),
			S(330, 227), S(329, 244), S(337, 256), S(337, 262),
			S(320, 227), S(335, 241), S(339, 253), S(338, 257),
			S(315, 224), S(337, 233), S(338, 239), S(343, 252),
			S(315, 208), S(308, 227), S(328, 234), S(336, 237),
			S(289, 206), S(319, 198), S(304, 225), S(320, 226),
		};

		constexpr Score bishop_table[] = {
			S(314, 231), S(332, 235), S(331, 233), S(329, 239),
			S(317, 234), S(348, 224), S(345, 238), S(344, 240),
			S(324, 242), S(345, 241), S(355, 242), S(344, 248),
			S(324, 242), S(330, 242), S(333, 248), S(349, 247),
		};

		constexpr Score rook_table[] = {
			S(440, 438), S(433, 445), S(443, 442), S(442, 442),
			S(414, 454), S(433, 449), S(440, 447), S(447, 442),
			S(419, 447), S(439, 446), S(439, 443), S(435, 443),
			S(418, 451), S(434, 447), S(440, 449), S(441, 444),
		};

		constexpr Score queen_table[] = {
			S(898, 792), S(889, 804), S(889, 810), S(905, 793),
			S(886, 804), S(870, 820), S(910, 799), S(904, 812),
			S(892, 813), S(905, 806), S(895, 823), S(892, 827),
			S(890, 817), S(877, 843), S(882, 830), S(880, 841),
		};

		constexpr Score king_table[] = {
			S(62, 14), S(99, 34), S(65, 57), S(71, 55),
			S(70, 43), S(100, 55), S(71, 76), S(53, 85),
			S(45, 56), S(86, 70), S(75, 83), S(69, 91),
			S(13, 59), S(63, 78), S(53, 94), S(40, 102),
		};

		constexpr Score passed_pawn[] = {
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(5, 6), S(5, 5), S(4, 5), S(4, 4),
			S(10, 122), S(0, 114), S(11, 89), S(4, 68),
			S(14, 61), S(4, 58), S(8, 39), S(7, 32),
			S(11, 34), S(0, 33), S(0, 18), S(0, 15),
			S(6, 11), S(0, 13), S(0, 3), S(0, 0),
			S(0, 11), S(4, 8), S(6, 0), S(0, 0),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};
		...
		constexpr Score rook_closed_file_penalty = S(15, 6);
		...
		constexpr Score rook_on_our_passer_file = S(7, 4);
		constexpr Score rook_on_their_passer_file = S(3, 44);
