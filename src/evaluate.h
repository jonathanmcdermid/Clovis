...
#define S(mg, eg) Score(mg, eg)
			...
			S(111, 277), S(149, 256), S(162, 228), S(165, 217),
			S(75, 86), S(92, 80), S(110, 77), S(105, 62),
			S(60, 76), S(79, 71), S(81, 71), S(94, 63),
			S(51, 69), S(61, 69), S(75, 67), S(91, 64),
			S(58, 64), S(71, 64), S(75, 69), S(78, 73),
			S(54, 65), S(76, 64), S(70, 76), S(71, 76),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};

		constexpr Score knight_table[] = {
			S(173, 184), S(245, 199), S(222, 226), S(297, 212),
			S(269, 208), S(294, 224), S(367, 207), S(322, 231),
			S(304, 206), S(349, 216), S(337, 237), S(348, 234),
			S(324, 218), S(323, 234), S(332, 245), S(332, 250),
			S(315, 218), S(329, 232), S(334, 243), S(334, 246),
			S(310, 216), S(332, 223), S(334, 228), S(338, 241),
			S(311, 201), S(308, 217), S(324, 224), S(333, 227),
			S(287, 198), S(314, 191), S(301, 216), S(316, 217),
		};

		constexpr Score bishop_table[] = {
			S(311, 222), S(326, 226), S(328, 223), S(325, 229),
			S(312, 225), S(343, 215), S(340, 228), S(340, 229),
			S(320, 232), S(340, 231), S(350, 232), S(339, 238),
			S(319, 232), S(326, 232), S(328, 238), S(343, 237),
		};

		constexpr Score rook_table[] = {
			S(439, 419), S(432, 426), S(442, 423), S(443, 422),
			S(413, 430), S(430, 426), S(438, 424), S(447, 419),
			S(417, 428), S(437, 428), S(438, 424), S(435, 424),
			S(416, 432), S(432, 428), S(439, 430), S(441, 425),
		};

		constexpr Score queen_table[] = {
			S(880, 779), S(861, 804), S(859, 819), S(881, 801),
			S(880, 779), S(841, 814), S(862, 816), S(836, 843),
			S(892, 780), S(882, 797), S(883, 801), S(863, 832),
			S(873, 808), S(868, 818), S(869, 810), S(863, 824),
			S(891, 777), S(878, 812), S(881, 805), S(881, 813),
			S(885, 791), S(903, 775), S(891, 798), S(892, 791),
			S(885, 773), S(898, 760), S(910, 762), S(904, 776),
			S(900, 754), S(891, 758), S(893, 761), S(906, 752),
		};

		constexpr Score king_table[] = {
			S(71, 18), S(104, 38), S(66, 61), S(71, 58),
			S(80, 42), S(108, 54), S(75, 76), S(52, 86),
			S(59, 54), S(95, 68), S(81, 82), S(70, 90),
			S(25, 58), S(74, 76), S(61, 91), S(45, 100),
		};

		constexpr Score passed_pawn[] = {
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(11, 120), S(4, 115), S(17, 89), S(10, 84),
			S(14, 61), S(6, 59), S(9, 40), S(6, 33),
			S(11, 34), S(0, 33), S(0, 18), S(0, 16),
			S(5, 12), S(0, 14), S(0, 4), S(0, 2),
			S(0, 12), S(2, 9), S(5, 0), S(0, 2),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};

		constexpr Score candidate_passer[] = {
			S(0, 0), S(0, 1), S(0, 4), S(5, 16), S(11, 36), S(23, 47), S(0, 0), S(0, 0),
		};
		...
		constexpr Score weak_queen_penalty = S(31, 6);
		constexpr Score rook_on_our_passer_file = S(7, 5);
		constexpr Score rook_on_their_passer_file = S(2, 41);
		constexpr Score tall_pawn_penalty = S(12, 23);
		constexpr Score fianchetto_bonus = S(18, 12);
		constexpr Score rook_on_seventh = S(3, 23);
		...
		constexpr short virtual_mobility = 13;
		constexpr short weak_inner_square = 19;
		constexpr short weak_outer_square = 15;	
