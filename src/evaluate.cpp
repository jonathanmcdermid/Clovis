...
#define S(mg, eg) Score(mg, eg)
		...
		Score pawn_table[] = {
			...
			S(132, 336), S(176, 311), S(188, 278), S(203, 261),
			S(93, 111), S(116, 108), S(146, 96), S(129, 99),
			S(76, 98), S(95, 92), S(97, 92), S(114, 82),
			S(66, 88), S(74, 89), S(94, 83), S(102, 83),
			S(73, 81), S(85, 82), S(91, 86), S(93, 90),
			S(67, 83), S(90, 81), S(82, 94), S(79, 97),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};

		Score knight_table[] = {
			S(182, 239), S(248, 264), S(237, 290), S(314, 279),
			S(287, 270), S(314, 291), S(401, 274), S(344, 303),
			S(326, 271), S(379, 284), S(368, 309), S(378, 307),
			S(348, 284), S(354, 304), S(362, 319), S(365, 324),
			S(339, 282), S(357, 302), S(363, 315), S(362, 320),
			S(333, 279), S(360, 290), S(363, 299), S(368, 313),
			S(335, 260), S(332, 281), S(350, 291), S(362, 294),
			S(306, 258), S(337, 252), S(324, 282), S(340, 282),
		};

		Score bishop_table[] = {
			S(318, 292), S(331, 301), S(333, 297), S(332, 302),
			S(316, 298), S(369, 289), S(348, 302), S(347, 304),
			S(325, 306), S(347, 306), S(357, 308), S(344, 316),
			S(325, 306), S(329, 309), S(331, 316), S(352, 313),
		};

		Score rook_table[] = {
			S(470, 538), S(486, 533), S(453, 544), S(499, 533),
			S(476, 540), S(473, 542), S(512, 531), S(519, 524),
			S(460, 535), S(493, 532), S(478, 534), S(475, 534),
			S(450, 539), S(464, 534), S(489, 536), S(482, 529),
			S(450, 535), S(471, 531), S(469, 533), S(479, 526),
			S(453, 523), S(471, 526), S(478, 520), S(472, 521),
			S(444, 527), S(473, 518), S(477, 519), S(484, 519),
			S(476, 513), S(470, 522), S(485, 517), S(484, 516),
		};

		Score queen_table[] = {
			S(933, 979), S(913, 1009), S(925, 1016), S(948, 997),
			S(927, 973), S(873, 1021), S(897, 1027), S(863, 1059),
			S(937, 979), S(921, 1002), S(923, 1008), S(891, 1049),
			S(915, 1014), S(907, 1029), S(904, 1022), S(897, 1037),
			S(933, 985), S(916, 1030), S(924, 1011), S(924, 1024),
			S(927, 997), S(946, 979), S(934, 1005), S(935, 1001),
			S(926, 976), S(943, 959), S(957, 961), S(952, 976),
			S(942, 954), S(936, 956), S(938, 959), S(951, 946),
		};

		Score king_table[] = {
			S(68, 2), S(105, 25), S(62, 53), S(69, 49),
			S(74, 38), S(111, 50), S(77, 73), S(53, 84),
			S(43, 53), S(99, 66), S(93, 80), S(80, 89),
		...
		Score passed_pawn[] = {
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
			S(17, 136), S(0, 130), S(5, 105), S(8, 79),
			S(16, 67), S(5, 66), S(11, 43), S(7, 36),
			S(13, 36), S(0, 35), S(0, 20), S(0, 16),
			S(6, 9), S(0, 12), S(0, 1), S(0, 1),
			S(0, 10), S(0, 8), S(0, 0), S(0, 0),
			S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		};
		...
		Score rook_on_their_passer_file = S(6, 46);
