...
Score pawn_table[] = {
	...
	S(68, 85), S(91, 82), S(88, 93), S(80, 97),
	S(0, 0), S(0, 0), S(0, 0), S(0, 0),
};
Score knight_table[] = {
	S(178, 241), S(254, 263), S(234, 292), S(313, 280),
	S(282, 272), S(315, 290), S(400, 274), S(345, 303),
	...
	S(335, 262), S(328, 283), S(352, 291), S(363, 296),
	S(302, 261), S(337, 254), S(322, 283), S(339, 284),
};
Score bishop_table[] = {
	S(316, 294), S(334, 301), S(331, 298), S(332, 303),
	S(317, 298), S(367, 293), S(346, 304), S(347, 306),
	S(323, 309), S(346, 307), S(357, 309), S(343, 317),
...
Score rook_closed_file_penalty = S(11, 1);
