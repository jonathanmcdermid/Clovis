...
Score knight_table[] = {
	...
	S(340, 284), S(356, 303), S(364, 316), S(362, 322),
...
Score rook_table[] = {
	...
	S(447, 535), S(468, 531), S(468, 533), S(477, 527),
	S(450, 524), S(471, 526), S(477, 520), S(473, 521),
	S(443, 525), S(474, 517), S(474, 520), S(483, 519),
...
Score queen_table[] = {
	...
	S(923, 996), S(945, 980), S(931, 1004), S(932, 997),
	S(925, 974), S(941, 957), S(955, 960), S(949, 974),
	S(943, 953), S(935, 955), S(937, 956), S(951, 946),
};
Score king_table[] = {
