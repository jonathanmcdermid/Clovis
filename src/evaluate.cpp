...
namespace Clovis {
    ...
    namespace Eval {
        ...
        int game_phase_inc[15] = { 0, 0, 1, 1, 2, 4, 0, 0, 0, 0, 1, 1, 2, 4, 0 };
        ...
        int evaluate(const Position& pos)
        {
            ...
            repeat:
                ...
                {
                    sq = get_lsb_index(bb);
                    mg_score[side] += mg_value[pt] + mg_table[piece][sq];
                    eg_score[side] += eg_value[pt] + eg_table[piece][sq];
            ...
            return (mg_score_comb * game_phase + eg_score_comb * (MAX_GAMEPHASE - game_phase)) / MAX_GAMEPHASE;
        }
